...
~~~sh
# getting the code
git clone git@github.com:nko4/team-ninja.git && cd ./team-ninja/

# developing
npm install
npm start

# deploying (to http://team-ninja.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@team-ninja.2013.nodeknockout.com
ssh root@team-ninja.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@team-ninja.2013.nodeknockout.com
ssh -i ./id_deploy root@team-ninja.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/team-ninja" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
